...
while not button_a.is_pressed():
    gc.enable()
    gc.collect()
    SeniorOS.system.ui.app('Flag 线上插件')
...
while not button_a.is_pressed():
    ...
    if touchpad_t.is_pressed() and touchpad_h.is_pressed():
        SeniorOS.system.core.consani(64, 64, 0, 0, 0, 0, 128, 64)
        SeniorOS.system.core.ui_app('Flag 线上插件')
        ...
        oled.fill(0)
        exec(_response.text)
        SeniorOS.system.core.consani(0, 0, 0, 0, 0, 0, 128, 64)