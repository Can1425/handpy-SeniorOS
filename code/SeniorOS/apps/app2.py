    ...
    def showText(self,lines=0,offset=0,y=0):
        for i in [0,1,2]:
            try:
                ...
                oled.DispChar(" ",0,0,Colormode.noshow)
...
class FileViewer:
    ...
    def selsetbox(self,textlist:str):
        ...
        while not button_a.is_pressed():
            ...
            Textreader(textlist,";").showText(offset=-4,y=2)
            oled.rect(2,(selset_num*16)+1,oled.DispChar(selsetlist[selset_num],0,0,Colormode.noshow)[0][0]+2,16,1)
            oled.show()
            ...
            while not button_a.is_pressed():
                ...
                while not button_a.is_pressed():
                    ...
                    if touchpad_t.is_pressed() or touchpad_h.is_pressed():
                        ...
                        self.boxmov("selset")
                        selset=self.selsetbox("文本阅读器;复制")
                        if selset=="文本阅读器":
...
class SelsetFile():
    def __init__(self):
        self.pathpic=bytearray([0X00,0X00,0X3E,0X00,0X41,0X00,0X80,0X80,0X81,0XFC,0XFE,0X02,0X80,0X01,0X80,0X01,0XFF,0XFF,0X80,0X01,0X80,0X01,0X80,0X01,0X80,0X01,0X80,0X01,0X40,0X02,0X3F,0XFC,])
        self.filepic=bytearray([0X00,0X00,0X3F,0XC0,0X20,0X60,0X2F,0X50,0X20,0X48,0X2F,0X7C,0X20,0X04,0X23,0XC4,0X22,0X04,0X23,0X84,0X22,0X04,0X22,0X04,0X22,0X04,0X20,0X04,0X3F,0XFC,0X00,0X00,])
        self.runpic=bytearray([0X00,0X00,0X3F,0XC0,0X20,0X60,0X2F,0X50,0X20,0X48,0X2F,0X7C,0X20,0X04,0X23,0XC4,0X22,0X04,0X23,0X84,0X22,0X04,0X22,0X04,0X22,0X04,0X20,0X04,0X3F,0XFC,0X00,0X00,])
        self.picpic=bytearray([0XFF,0XFF,0X80,0X01,0X8C,0X01,0X92,0X01,0X92,0X09,0X8C,0X15,0X80,0X23,0X84,0X41,0X8A,0X81,0X91,0X01,0XA0,0X01,0XC0,0X01,0X80,0X01,0X80,0X01,0X80,0X01,0XFF,0XFF,])
    def IsFile(self,f):
        print(f)
        if os.stat(f)[0]<20000:return "目录"
        else:
