...
def about():
    oled.fill(0)
    while not button_a.is_pressed():
        oled.Bitmap(32, 12, logo_SeniorOS, 64, 18, 1)
        oled.show()
    UI.consani(0, 0, 0, 0, 0, 0, 128, 64)
